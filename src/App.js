...
export default class App extends Component {
    ...
    async _startCheckout() {
        try {
            // order token you get from createOrder API, orderId, environment
            const session = new CFSession('TVgnsJO0AB2fC4jBXau6', 'test_order_12_08_03', CFEnvironment.SANDBOX);
